<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="beginTime" width="150px" align="center" prop="beginTime" />
      <el-table-column label="lastPushTime" width="150px" align="center" prop="lastPushTime" />
      <el-table-column label="lostTime" width="150px" align="center" prop="lostTime" />
      <el-table-column label="connId" width="150px" align="center" prop="connId" />
      <el-table-column label="roomId" width="150px" align="center" prop="roomId" />
      ...
      <el-table-column label="addr" width="150px" align="center" prop="addr" />
      <el-table-column label="nodeId" width="150px" align="center" prop="nodeId" />
      <el-table-column label="head" width="150px" align="center" prop="head" />
