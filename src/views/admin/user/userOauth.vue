<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="OauthType" width="150px" align="center" prop="oauthType" />
      <el-table-column label="OpenId" width="150px" align="center" prop="openId" />
      <el-table-column label="UnionId" width="150px" align="center" prop="unionId" />
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        <el-form-item label="OauthType" prop="oauthType">
          <el-input v-model="temp.oauthType" />
        </el-form-item>
        <el-form-item label="OpenId" prop="openId">
          <el-input v-model="temp.openId" />
        </el-form-item>
        <el-form-item label="UnionId" prop="unionId">
          <el-input v-model="temp.unionId" />
        </el-form-item>
...
<script>
import { createUserOauth, updateUserOauth, deleteUserOauth, findUserOauthById, findUserOauthList } from '@/api/userOauth'
  ...
  methods: {
    ...
    async createData() {
      this.$refs['dataForm'].validate(async(valid) => {
        if (valid) {
          const res = await createUserOauth(this.temp)
          if (res.code === 'Success') {
            this.handleFilter()
    ...
    async updateData() {
      this.$refs['dataForm'].validate(async(valid) => {
        if (valid) {
          const res = await updateUserOauth(this.temp)
          if (res.code === 'Success') {
            this.dialogFormVisible = false
            this.$notify({
              title: 'Success',
