...
$root.pbauth = (function() {
  ...
  pbauth.LoginArgs = (function() {
    /**
         * Properties of a LoginArgs.
         * @memberof pbauth
         * @interface ILoginArgs
         * @property {pbauth.LoginArgs.loginType|null} [type] LoginArgs type
         * @property {string|null} [code] LoginArgs code
         * @property {string|null} [state] LoginArgs state
         * @property {string|null} [applicationName] LoginArgs applicationName
         * @property {string|null} [account] LoginArgs account
    ...
    /**
         ...
         * @memberof pbauth
         * @classdesc Represents a LoginArgs.
         * @implements ILoginArgs
         * @constructor
         * @param {pbauth.ILoginArgs=} [properties] Properties to set
         */
    function LoginArgs(properties) {
      if (properties) {
        for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i) {
          if (properties[keys[i]] != null) { this[keys[i]] = properties[keys[i]] }
        }
    ...
    /**
         * LoginArgs type.
         * @member {pbauth.LoginArgs.loginType} type
         * @memberof pbauth.LoginArgs
         * @instance
         */
    LoginArgs.prototype.type = 0
    ...
    /**
         ...
         * @instance
         */
    LoginArgs.prototype.state = ''

    /**
         * LoginArgs applicationName.
         * @member {string} applicationName
         * @memberof pbauth.LoginArgs
         * @instance
         */
    LoginArgs.prototype.applicationName = ''
    ...
    /**
         ...
         * @instance
         */
    LoginArgs.prototype.captchaId = ''

    /**
         * LoginArgs captchaCode.
         * @member {string} captchaCode
         * @memberof pbauth.LoginArgs
         * @instance
         */
    ...
    /**
         ...
         * @static
         * @param {pbauth.ILoginArgs=} [properties] Properties to set
         * @returns {pbauth.LoginArgs} LoginArgs instance
         */
    LoginArgs.create = function create(properties) {
      return new LoginArgs(properties)
    }

    /**
         * Encodes the specified LoginArgs message. Does not implicitly {@link pbauth.LoginArgs.verify|verify} messages.
         * @function encode
         * @memberof pbauth.LoginArgs
         * @static
         * @param {pbauth.ILoginArgs} message LoginArgs message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
    LoginArgs.encode = function encode(message, writer) {
      if (!writer) { writer = $Writer.create() }
      if (message.type != null && Object.hasOwnProperty.call(message, 'type')) { writer.uint32(/* id 1, wireType 0 =*/8).int32(message.type) }
      if (message.code != null && Object.hasOwnProperty.call(message, 'code')) { writer.uint32(/* id 2, wireType 2 =*/18).string(message.code) }
      if (message.state != null && Object.hasOwnProperty.call(message, 'state')) { writer.uint32(/* id 3, wireType 2 =*/26).string(message.state) }
      if (message.applicationName != null && Object.hasOwnProperty.call(message, 'applicationName')) { writer.uint32(/* id 4, wireType 2 =*/34).string(message.applicationName) }
      if (message.account != null && Object.hasOwnProperty.call(message, 'account')) { writer.uint32(/* id 5, wireType 2 =*/42).string(message.account) }
      ...
      if (message.captchaId != null && Object.hasOwnProperty.call(message, 'captchaId')) { writer.uint32(/* id 7, wireType 2 =*/58).string(message.captchaId) }
      if (message.captchaCode != null && Object.hasOwnProperty.call(message, 'captchaCode')) { writer.uint32(/* id 8, wireType 2 =*/66).string(message.captchaCode) }
      return writer
    }

    /**
         * Encodes the specified LoginArgs message, length delimited. Does not implicitly {@link pbauth.LoginArgs.verify|verify} messages.
         * @function encodeDelimited
         * @memberof pbauth.LoginArgs
         * @static
         * @param {pbauth.ILoginArgs} message LoginArgs message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
    LoginArgs.encodeDelimited = function encodeDelimited(message, writer) {
      return this.encode(message, writer).ldelim()
    }
    ...
    /**
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {pbauth.LoginArgs} LoginArgs
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
    LoginArgs.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) { reader = $Reader.create(reader) }
      var end = length === undefined ? reader.len : reader.pos + length; var message = new $root.pbauth.LoginArgs()
      while (reader.pos < end) {
        var tag = reader.uint32()
        switch (tag >>> 3) {
          case 1: {
    ...
    /**
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
    LoginArgs.decodeDelimited = function decodeDelimited(reader) {
      if (!(reader instanceof $Reader)) { reader = new $Reader(reader) }
      return this.decode(reader, reader.uint32())
    }
    ...
    /**
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
    LoginArgs.verify = function verify(message) {
      if (typeof message !== 'object' || message === null) { return 'object expected' }
      if (message.type != null && message.hasOwnProperty('type')) {
        switch (message.type) {
          default:
      ...
      if (message.applicationName != null && message.hasOwnProperty('applicationName')) {
        if (!$util.isString(message.applicationName)) { return 'applicationName: string expected' }
      }
    ...
    /**
         ...
         * @returns {pbauth.LoginArgs} LoginArgs
         */
    LoginArgs.fromObject = function fromObject(object) {
      if (object instanceof $root.pbauth.LoginArgs) { return object }
      var message = new $root.pbauth.LoginArgs()
      switch (object.type) {
        default:
      ...
      if (object.applicationName != null) { message.applicationName = String(object.applicationName) }
    ...
    /**
         ...
         * @memberof pbauth.LoginArgs
         * @static
         * @param {pbauth.LoginArgs} message LoginArgs
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
    LoginArgs.toObject = function toObject(message, options) {
      if (!options) { options = {} }
      var object = {}
      if (options.defaults) {
      ...
      if (message.type != null && message.hasOwnProperty('type')) { object.type = options.enums === String ? $root.pbauth.LoginArgs.loginType[message.type] === undefined ? message.type : $root.pbauth.LoginArgs.loginType[message.type] : message.type }
      if (message.code != null && message.hasOwnProperty('code')) { object.code = message.code }
      if (message.state != null && message.hasOwnProperty('state')) { object.state = message.state }
      if (message.applicationName != null && message.hasOwnProperty('applicationName')) { object.applicationName = message.applicationName }
    ...
    /**
         ...
         * @returns {Object.<string,*>} JSON object
         */
    LoginArgs.prototype.toJSON = function toJSON() {
      return this.constructor.toObject(this, $protobuf.util.toJSONOptions)
    }

    /**
         * Gets the default type url for LoginArgs
         * @function getTypeUrl
         * @memberof pbauth.LoginArgs
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
    LoginArgs.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
      if (typeUrlPrefix === undefined) {
        typeUrlPrefix = 'type.googleapis.com'
      }
      return typeUrlPrefix + '/pbauth.LoginArgs'
    }

    /**
         * loginType enum.
         * @name pbauth.LoginArgs.loginType
         * @enum {number}
         * @property {number} none=0 none value
         * @property {number} Wechat=1 Wechat value
         * @property {number} Casdoor=2 Casdoor value
         * @property {number} pwd=3 pwd value
    ...
    LoginArgs.loginType = (function() {
      ...
      values[valuesById[2] = 'Casdoor'] = 2
      values[valuesById[3] = 'pwd'] = 3
  ...
  pbauth.Auth = (function() {
    ...
    /**
         * Callback as used by {@link pbauth.Auth#anonymouslyLogin}.
         * @memberof pbauth.Auth
         * @typedef AnonymouslyLoginCallback
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {pbauth.AuthLoginReply} [response] AuthLoginReply
         */
    ...
    /**
         * Calls AnonymouslyLogin.
         * @function anonymouslyLogin
         * @memberof pbauth.Auth
         * @instance
         * @param {pbcommon.IEmpty} request Empty message or plain object
         * @param {pbauth.Auth.AnonymouslyLoginCallback} callback Node-style callback called with the error, if any, and AuthLoginReply
         * @returns {undefined}
         * @variation 1
         */
    Object.defineProperty(Auth.prototype.anonymouslyLogin = function anonymouslyLogin(request, callback) {
      return this.rpcCall(anonymouslyLogin, $root.pbcommon.Empty, $root.pbauth.AuthLoginReply, request, callback)
    }, 'name', { value: 'AnonymouslyLogin' })
    ...
    /**
         * Callback as used by {@link pbauth.Auth#login}.
         * @memberof pbauth.Auth
    ...
    /**
         ...
         * @memberof pbauth.Auth
         * @instance
         * @param {pbauth.ILoginArgs} request LoginArgs message or plain object
         * @param {pbauth.Auth.LoginCallback} callback Node-style callback called with the error, if any, and AuthLoginReply
         * @returns {undefined}
         * @variation 1
         */
    Object.defineProperty(Auth.prototype.login = function login(request, callback) {
      return this.rpcCall(login, $root.pbauth.LoginArgs, $root.pbauth.AuthLoginReply, request, callback)
    }, 'name', { value: 'Login' })
